...
canvas.title("Corona Statistics In The World")
...
toaster.show_toast('Created By Regular Mahdi','__________________________________________________',icon_path="regular1.ico",duration=20)
